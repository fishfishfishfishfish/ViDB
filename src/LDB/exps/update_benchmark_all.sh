...
python3 plot_update_benchmark.py ${resdir}/results_qldb update_benchmark_${timestamp}
./update_benchmark.sh sqlledger $timestamp > ${logdir}/update_benchmark_sqlledger_${timestamp}.log 2>&1
python3 plot_update_benchmark.py ${resdir}/results_sqlledger update_benchmark_${timestamp}
./update_benchmark.sh ledgerdb $timestamp > ${logdir}/update_benchmark_ledgerdb_${timestamp}.log 2>&1
python3 plot_update_benchmark.py ${resdir}/results_ledgerdb update_benchmark_${timestamp}
